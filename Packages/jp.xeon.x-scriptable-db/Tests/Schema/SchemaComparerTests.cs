...
namespace Xeon.XScriptableDB.Tests
{
    ...
    public class SchemaComparerTests
    {
        ...
        private class FieldTypeChangedRecord
        {
            ...
            public int Id;
            public string Name;
            public float Value; // int -> float に変更
            public bool Active;
        }
        ...
        private class SecondaryKeyAddedRecord
        {
            ...
            public int Id;
            [SecondaryKey]
            public string Name; // SecondaryKey追加
            public int Value;
            public bool Active;
        }
        ...
        private class MultipleChangesRecord
        {
            ...
            // Active削除
            public string Category; // 新規フィールド
            public int Level; // 新規フィールド
        }
        ...
        public void Compare_FieldAdded_DetectsAddition()
        {
            ...
            Assert.That(result.IsCompatible, Is.True); // フィールド追加は互換性あり
        }
        ...
        public void Compare_FieldRemoved_DetectsRemoval()
        {
            ...
            Assert.That(result.IsCompatible, Is.False); // フィールド削除は非互換
        }
        ...
        public void Compare_PrimaryKeyChanged_DetectsKeyChange()
        {
            ...
            Assert.That(keyChanges.Count, Is.EqualTo(2)); // Id削除、Name追加
        }
